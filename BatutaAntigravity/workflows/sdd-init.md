...
> Bootstrap Spec-Driven Development in this project. Detects project type (webapp, automation, ai-agent, infrastructure, data-pipeline, library) and creates the openspec/ directory structure.
...
3. The skill will detect the project type and create the appropriate `openspec/` directory with its initial artifacts.
