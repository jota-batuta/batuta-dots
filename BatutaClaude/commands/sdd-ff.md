...
name: sdd-ff
description: >
  Fast-forward through SDD planning: explore then design (2 steps).
  Use when you want to go from idea to actionable design quickly.
...
Run the two planning phases in sequence: explore -> design.
...
1. **Explore** -- `~/.claude/skills/sdd-explore/SKILL.md` -> `explore.md`
2. **Design** -- `~/.claude/skills/sdd-design/SKILL.md` -> `design.md`
