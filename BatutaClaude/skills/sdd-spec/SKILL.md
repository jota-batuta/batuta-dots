...
metadata:
  ...
  created: "2026-02-20"
  scope: [pipeline]
  auto_invoke: "Writing specifications"
...
Write specs that a non-technical stakeholder can read and understand. Every requirement should be clear enough that a project manager, designer, or business analyst can validate it without needing to read code. Think like a CTO explaining the system to the rest of the leadership team.
