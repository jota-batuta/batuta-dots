...
description: >
  ...
  Contract: read-only reviewer — audits code, does NOT modify it.
tools: Read, Grep, Glob
model: opus  # Security reasoning benefits from deeper analysis; opus recommended for complex threat models
skills: security-audit, compliance-colombia
maxTurns: 25
---
